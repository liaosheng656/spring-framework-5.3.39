...
public class MyConfigurationClassPostProcessor03
        ...
        implements BeanDefinitionRegistryPostProcessor
{
    ...
    public void postProcessBeanFactory(ConfigurableListableBeanFactory beanFactory) throws BeansException {
        ...
        if(beanFactory instanceof DefaultListableBeanFactory){
            ...
            defaultBeanFactory.registerBeanDefinition("myConfigurationClassPostProcessor04",rootBeanDefinition02);
            System.out.println("BeanFactoryPostProcessor.postProcessBeanFactory方法注册的PostProcessor" +
                    "不会被回调了");
        }
